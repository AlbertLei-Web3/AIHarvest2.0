  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="max-w-md mx-auto">
        <div className="bg-[rgba(22,33,62,0.5)] backdrop-blur-md rounded-2xl p-8 shadow-lg border border-primary/10">
          <div className="flex items-center justify-between mb-6">
            <h1 className="text-2xl font-bold text-white">{st('swap')}</h1>
            {/* Settings icon with slippage setting - Hidden as requested */}
      ...
      {showTokenModal && (
        <div className="fixed inset-0 z-50 overflow-y-auto">
          <div className="flex items-center justify-center min-h-screen px-4">
            ...
            <div className="bg-[rgba(22,33,62,0.95)] backdrop-blur-md rounded-2xl p-6 w-full max-w-md relative">
              <div className="flex items-center justify-between mb-6">
